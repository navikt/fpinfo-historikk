...
public interface MinidialogRepository
    ...
    int deaktiverSak(@Param("aktørId") String aktørId, @Param("handling") SøknadType handling,
    ...
    int deaktiver(@Param("aktørId") String aktørId, @Param("handling") SøknadType handling);
}
